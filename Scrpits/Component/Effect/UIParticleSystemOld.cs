    ...
    public class UIParticleSystemOld : MaskableGraphic
    {
        ...
        protected override void OnPopulateMesh(VertexHelper vh)
        {
            ...
            for (int i = 0; i < count; ++i)
            {
                ...
                Vector3 rotation3D = particle.rotation3D * Mathf.Deg2Rad;
                ...
                else
                {
                    ...
                    if(rotation3D.x!=0 && rotation3D.y!=0)
                    {
                        right = right * Mathf.Cos(rotation3D.x);
                        up = up * Mathf.Sin(rotation3D.y);
                    }
